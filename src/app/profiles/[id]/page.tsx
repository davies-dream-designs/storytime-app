      ...
      <main className="mx-auto max-w-5xl px-5 py-10">
        ...
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex gap-3">
            <Link
              href={`/stories/new?profileId=${id}`}
              className="rounded-full bg-night-700 px-5 py-2.5 font-bold text-moon-200 transition hover:bg-night-600"
            >
              ✨ Generate story
            </Link>
          ...
          <div className="lg:col-span-2">
            ...
            {stories.length === 0 ? (
              <div className="rounded-2xl border-2 border-dashed border-night-200 p-10 text-center">
                ...
                <Link
                  href={`/stories/new?profileId=${id}`}
                  className="mt-4 inline-block rounded-full bg-night-700 px-5 py-2.5 text-sm font-bold text-moon-200 transition hover:bg-night-600"
                >
                  Generate a story
                </Link>
              </div>
