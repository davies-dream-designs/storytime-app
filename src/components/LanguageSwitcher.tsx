        ...
        <div className="absolute right-0 top-full z-50 mt-2 w-36 overflow-hidden rounded-xl border border-night-100 bg-white shadow-lg">
          {routing.locales.map((l) => (
            <button
              ...
              className={`flex w-full items-center gap-2.5 px-4 py-2.5 text-sm transition hover:bg-night-50 ${l === locale ? 'font-bold text-night-800 bg-night-50' : 'text-night-600'}`}
            >
              <span className="w-6 shrink-0 text-xs font-bold text-night-400">{LOCALE_SHORT[l]}</span>
