...
export const LULU_HARDCOVER_CASEWRAP_WRAP_IN = 0.75;
export const LULU_HARDCOVER_COVER_PANEL_WIDTH_IN =
  LULU_TRIM_WIDTH_IN + LULU_HARDCOVER_CASEWRAP_WRAP_IN;
export const LULU_HARDCOVER_COVER_PAGE_HEIGHT_IN =
  LULU_TRIM_HEIGHT_IN + LULU_HARDCOVER_CASEWRAP_WRAP_IN * 2;
